...
public class Queries {
    public static final String CRIA_TABELA_BRINQUEDOS_SQL = "CREATE TABLE IF NOT EXISTS brinquedos (" // cria a tabela somente se não existir na base
    ...
    public static final String CRIA_TABELA_FUNCIONARIOS_SQL = "CREATE TABLE IF NOT EXISTS funcionarios (" // cria a tabela somente se não existir na base
    ...
    public static final String CRIA_TABELA_ENDERECOS_SQL = "CREATE TABLE IF NOT EXISTS enderecos (" // cria a tabela somente se não existir na base
    ...
    public static final String CRIA_TABELA_VENDAS_SQL = "CREATE TABLE IF NOT EXISTS vendas (" // cria a tabela somente se não existir na base
